...
//    }
    ...
    public ResponseEntity<List<com.usth_connect.vpn_server_backend_usth.entity.schedule.Event>> getEventsForUser(@RequestParam Integer organizerId) {

        List<com.usth_connect.vpn_server_backend_usth.entity.schedule.Event> events = eventService.getEventsByOrganizer(organizerId);
